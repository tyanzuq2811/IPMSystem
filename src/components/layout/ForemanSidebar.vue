  ...
  <aside class="w-64 bg-gradient-to-b from-ocean-900 via-ocean-800 to-ocean-900 shadow-2xl flex flex-col">
    <div class="p-6 border-b border-ocean-700/50">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xs text-cyan-200/70">Foreman</p>
        </div>
      </div>
    </div>
    ...
    <nav class="flex-1 py-4 px-2 space-y-1 overflow-y-auto">
      <router-link 
        ...
        :class="{'active': $route.path === '/foreman/dashboard'}"
      >
        <span>Dashboard</span>
      </router-link>
      
      <router-link 
        to="/foreman/materials/request" 
        class="nav-item group"
        :class="{'active': $route.path === '/foreman/materials/request'}"
      >
      ...
      <router-link 
        to="/foreman/chat" 
        class="nav-item group"
        :class="{'active': $route.path === '/foreman/chat'}"
      >
        <span>Chat với PM</span>
      </router-link>
      
      <router-link 
        to="/foreman/profile" 
        class="nav-item group"
        :class="{'active': $route.path === '/foreman/profile'}"
      >
        <span>Hồ sơ</span>
      </router-link>
    </nav>
